            ...
            for (int c = 0; c < str.Length; c++)
            {
                ...
                for (int i = 0; i < 16; i++)
                {
                    for (int j = 0; j < 8; j++)
                    {
                        ...
                        {
                            int index = x + ((i + y) * bufferWidth) + j + (c * 8);
